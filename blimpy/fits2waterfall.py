...
Python class and command line utility for reading LOFAR LoTSS FITS dynamic spectra and creating waterfall files.

This provides a class, LoTSSWaterfall(), which can be used to read a FITS file:


    fil = LoTSSWaterfall("lotss_test.fits")
    print(fil.header)
